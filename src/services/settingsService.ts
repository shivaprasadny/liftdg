...
export const DEFAULT_SETTINGS: AppSettings = {
  ...
  heightUnit: 'cm', bodyMeasurementUnit: 'cm', showBodyProgressHome: true, hideDefaultExerciseVideos: false,
...
const settingsSchema = z.object({
  ...
  heightUnit: z.enum(['cm', 'ft_in']), bodyMeasurementUnit: z.enum(['cm', 'in']), showBodyProgressHome: z.boolean(), hideDefaultExerciseVideos: z.boolean(),
