...
export function FilterChip({ label, selected, onPress }: Props) {
  return <Pressable accessibilityRole="button" accessibilityLabel={`${label}${selected ? ', selected' : ''}`} accessibilityState={{ selected }} onPress={onPress}
...
const styles = StyleSheet.create({
  chip: { minHeight: 44, justifyContent: 'center', paddingHorizontal: spacing.md,
