...
- [ ] The expand arrow reveals week → month → quarter → year one tap at a time and collapses fully on the last tap.
- [ ] "Remember expanded card" restores the last expansion level after an app restart; disabling it always starts collapsed.
